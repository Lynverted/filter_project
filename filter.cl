...
eth_classifier1[0] -> Discard;                               // drop requests
eth_classifier1[1] -> mainOut;                               // forward responses
eth_classifier1[2] -> Strip(14) -> CheckIPHeader() -> clas;  // all other traffic
clas[0] -> Unstrip(14) -> clone;                             // syn packets
clas[1] -> Unstrip(14) -> mainOut;                           // All other traffic
clone[0] -> backupOut;                                       // SYN to backup
clone[1] -> mainOut;                                         // SYN to main
